...
html +=                 '<h3 class="extremum-click">Подробная информация<i class="fas fa-chevron-down arrow"></i></h3>'
html +=             '<div class="extremum-slide">'
html +=                 '<br/><label class="description col-md-12">Количество резов на лист: <label id="checkStickersCuts" ></label></label>'
html +=                 '<br/><label id="checkStickersField" class="description col-md-12"></label>'
html +=                 '<br/><label id="checkStickers" class="description col-md-12"></label>'
html +=             '</div><br/>'
html +=         '</div>'
html += '</div>'
...
html +=     '</div>'
html +=         '<div class="col-md-12 final-cost-block">'
html +=             '<label id="final-costWobblers" class="final-cost-description"></label><br/>'
html +=         '</div>'
html +=         '<div class="col-md-12">'
html +=             '<div class="col-md-12 block">'				
html +=                 '<h3 class="extremum-click">Подробная информация<i class="fas fa-chevron-down arrow"></i></h3>'
...
function calculateWobblers() {
    ...
    finalCostWobblers.innerHTML = "Общая стоимость, руб: " + ((allCost * (jsonObjDollar * jsonC.dollarCoeff))).toFixed(2) + " BYN" +  "<br />";
